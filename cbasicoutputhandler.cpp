...
{
    CBasicOutputHandler *output = static_cast<CBasicOutputHandler*>(data);
...
struct CSimpleOutput : CBasicOutputHandler {
...
void CSimpleOutput::LoadRecordingPreset_Lossless()
{
...
void CSimpleOutput::LoadRecordingPreset_h264(const char *encoderId)
{
...
void CSimpleOutput::LoadStreamingPreset_h264(const char *encoderId)
{
...
void CSimpleOutput::LoadRecordingPreset()
{
    const char *quality = config_get_string(main->Config(), "CSimpleOutput",
            "RecQuality");
    const char *encoder = config_get_string(main->Config(), "CSimpleOutput",
            "RecEncoder");
...
CSimpleOutput::CSimpleOutput(COBSBasic *main_) : CBasicOutputHandler(main_)
{
...
int CSimpleOutput::GetAudioBitrate() const
{
    int bitrate = (int)config_get_uint(main->Config(), "CSimpleOutput",
            "ABitrate");

    return FindClosestAvailableAACBitrate(bitrate);
}

void CSimpleOutput::Update()
{
    obs_data_t *h264Settings = obs_data_create();
    obs_data_t *aacSettings  = obs_data_create();

    int videoBitrate = config_get_uint(main->Config(), "CSimpleOutput",
            "VBitrate");
    int audioBitrate = GetAudioBitrate();
    bool advanced = config_get_bool(main->Config(), "CSimpleOutput",
            "UseAdvanced");
    bool enforceBitrate = config_get_bool(main->Config(), "CSimpleOutput",
            "EnforceBitrate");
    const char *custom = config_get_string(main->Config(),
            "CSimpleOutput", "x264Settings");
    const char *encoder = config_get_string(main->Config(), "CSimpleOutput",
            "StreamEncoder");
    ...
    preset = config_get_string(main->Config(), "CSimpleOutput", presetType);
...
void CSimpleOutput::UpdateRecordingAudioSettings()
{
    obs_data_t *settings = obs_data_create();
...
int CSimpleOutput::CalcCRF(int crf)
{
...
void CSimpleOutput::UpdateRecordingSettings_x264_crf(int crf)
{
    obs_data_t *settings = obs_data_create();
...
void CSimpleOutput::UpdateRecordingSettings_qsv11(int crf)
{
...
void CSimpleOutput::UpdateRecordingSettings_nvenc(int cqp)
{
    obs_data_t *settings = obs_data_create();
    obs_data_set_string(settings, "rate_control", "CQP");
    obs_data_set_string(settings, "profile", "high");
...
void CSimpleOutput::UpdateStreamingSettings_amd(obs_data_t *settings,
        int bitrate)
{
    // Static Properties
...
void CSimpleOutput::UpdateRecordingSettings_amd_cqp(int cqp)
{
    obs_data_t *settings = obs_data_create();
...
void CSimpleOutput::UpdateRecordingSettings()
{
...
inline void CSimpleOutput::SetupOutputs()
{
    CSimpleOutput::Update();
...
bool CSimpleOutput::StartStreaming(obs_service_t *service)
{
    if (!Active())
        SetupOutputs();
...
void CSimpleOutput::UpdateRecording()
{
...
bool CSimpleOutput::ConfigureRecording(bool updateReplayBuffer)
{
    const char *path = config_get_string(main->Config(),
            "CSimpleOutput", "FilePath");
    const char *format = config_get_string(main->Config(),
            "CSimpleOutput", "RecFormat");
    const char *mux = config_get_string(main->Config(), "CSimpleOutput",
            "MuxerCustom");
    bool noSpace = config_get_bool(main->Config(), "CSimpleOutput",
    ...
    bool overwriteIfExists = config_get_bool(main->Config(), "Output",
                "OverwriteIfExists");
    const char *rbPrefix = config_get_string(main->Config(), "CSimpleOutput",
                "RecRBPrefix");
    const char *rbSuffix = config_get_string(main->Config(), "CSimpleOutput",
                "RecRBSuffix");
    int rbTime = config_get_int(main->Config(), "CSimpleOutput",
            "RecRBTime");
    int rbSize = config_get_int(main->Config(), "CSimpleOutput",
            "RecRBSize");
...
bool CSimpleOutput::StartRecording()
{
    UpdateRecording();
...
bool CSimpleOutput::StartReplayBuffer()
{
    UpdateRecording();
...
void CSimpleOutput::StopStreaming(bool force)
{
    if (force)
...
void CSimpleOutput::StopRecording(bool force)
{
    if (force)
...
void CSimpleOutput::StopReplayBuffer(bool force)
{
    if (force)
...
bool CSimpleOutput::StreamingActive() const
{
    return obs_output_active(streamOutput);
}

bool CSimpleOutput::RecordingActive() const
{
    return obs_output_active(fileOutput);
}

bool CSimpleOutput::ReplayBufferActive() const
{
...
struct CAdvancedOutput : CBasicOutputHandler {
    ...
    CAdvancedOutput(COBSBasic *main_);
...
CAdvancedOutput::CAdvancedOutput(COBSBasic *main_) : CBasicOutputHandler(main_)
{
...
void CAdvancedOutput::UpdateStreamSettings()
{
...
inline void CAdvancedOutput::UpdateRecordingSettings()
{
    OBSData settings = GetDataFromJsonFile("recordEncoder.json");
    obs_encoder_update(h264Recording, settings);
}

void CAdvancedOutput::Update()
{
...
inline void CAdvancedOutput::SetupStreaming()
{
...
inline void CAdvancedOutput::SetupRecording()
{
...
inline void CAdvancedOutput::SetupFFmpeg()
{
...
inline void CAdvancedOutput::UpdateAudioSettings()
{
    bool applyServiceSettings = config_get_bool(main->Config(), "AdvOut",
            "ApplyServiceSettings");
...
void CAdvancedOutput::SetupOutputs()
{
    obs_encoder_set_video(h264Streaming, obs_get_video());
    if (h264Recording)
        obs_encoder_set_video(h264Recording, obs_get_video());
...
int CAdvancedOutput::GetAudioBitrate(size_t i) const
{
...
bool CAdvancedOutput::StartStreaming(obs_service_t *service)
{
    if (!useStreamEncoder ||
...
bool CAdvancedOutput::StartRecording()
{
    const char *path;
...
void CAdvancedOutput::StopStreaming(bool force)
{
    if (force)
        obs_output_force_stop(streamOutput);
    else
...
void CAdvancedOutput::StopRecording(bool force)
{
    if (force)
        obs_output_force_stop(fileOutput);
    else
...
bool CAdvancedOutput::StreamingActive() const
{
    return obs_output_active(streamOutput);
}

bool CAdvancedOutput::RecordingActive() const
{
    return obs_output_active(fileOutput);
}
...
CBasicOutputHandler *CreateCSimpleOutputHandler(COBSBasic *main)
{
    return new CSimpleOutput(main);
}

CBasicOutputHandler *CreateCAdvancedOutputHandler(COBSBasic *main)
{
    return new CAdvancedOutput(main);
}
